...
import 'package:radaspu_2/model/safety_helper.dart';
import 'package:radaspu_2/screens/safetycontent.dart';
import 'package:radaspu_2/theme.dart';
import 'package:radaspu_2/utils/details_helper.dart';
import 'package:radaspu_2/utils/drugs_helper.dart';
...
import 'article.dart';
import 'content.dart';
import 'drugscontent.dart';
import 'healthcontent.dart';
import 'hivcontent.dart';
import 'mentalcontent.dart';
import 'otherscontent.dart';
...
class _InformationState extends State<Information> {
  ...
  late ReproHelper reproHelper;
  late HivHelper hivHelper;
  late SafetyHelper safetyHelper;
  late DrugsHelper drugsHelper;
  late MentalHelper mentalHelper;
  late HealthHelper healthHelper;
  late OthersHelper othersHelper;
  late DetailsHelper detailsHelper;

  FirebaseFirestore firestore = FirebaseFirestore.instance;

  void getNews() async {
    print('Fetching news...');
    var url = Uri.parse('http://rada.uonbi.ac.ke/radaweb/api/news/get');
    http.Response response = await http.get(url,
        headers: {"Accept": "application/json"});
    var convert = await jsonDecode(response.body);
  ...
  Future<String> updateContent(synced) async {
    ...
    for (var k in categories) {
      var url = Uri.parse('http://rada.uonbi.ac.ke/radaweb/categories/get/$k');
      http.Response response = await http.get(url,
          headers: {"Accept": "application/json"});
