...
import 'package:radaspu_2/model/drugsmodel.dart';
...
class DrugsContent extends StatefulWidget {
  ...
  DrugsContent(
      {Key? key, required this.id, required this.name, required this.image, required this.itemkey})
      : super(key: key);
        ...
        home: Scaffold(
          ...
          builder: (context, projectSnap) {
            if (projectSnap.hasData) {
              ...
              var myList = projectSnap.data! as List<DrugsModel>;
              return ListView.builder(
                itemCount: projectSnap.data == null ? 0 : 1,
                itemBuilder: (context, index) {
                  DrugsModel project = myList[0];
