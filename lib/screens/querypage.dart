...
import 'package:radaspu_2/screens/allissues.dart';
...
class QueryPage extends StatefulWidget {
  ...
  QueryPage({Key? key, required this.id, required this.name}) : super(key: key);
...
class _QueryPageState extends State<QueryPage> {
  ...
  void getFaculties() async {
    ...
    var url = Uri.parse('http://rada.uonbi.ac.ke/radaweb/api/faculties/get/1');
  ...
  void sendRequest(BuildContext context) async {
    ...
    var url = Uri.parse('http://rada.uonbi.ac.ke/radaweb/api/help/store');
                ...
                return InputDecorator(
                  decoration: InputDecoration(
                      focusedBorder: OutlineInputBorder(
                        ...
                        borderSide: BorderSide(color:AppColours.colorMain),
