...
class ContentPage extends StatefulWidget {
  ...
  ContentPage({Key? key, required this.id, required this.name, required this.image, required this.itemkey})
      : super(key: key);
...
class _ContentPageState extends State<ContentPage> {
  ...
  Future<String> getContent() async {
    print("Stating..............");
    var url = Uri.parse('http://rada.spu.ac.ke/categories/get/${widget.itemkey}');
            ...
            if (projectSnap.hasData) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  Reproductive project = myList[0];
                  Reproductive project2 =myList[2];
                  Reproductive project3 = myList[1];
                  Reproductive project4 = myList[3];
